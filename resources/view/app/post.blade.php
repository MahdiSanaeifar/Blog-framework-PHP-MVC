            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span
                            class="mr-2"><a href="index.html">خاه</a></span> <span class="mr-2"><a
                                href="<?= route('home.all.post') ?>">بلاگ ها</a></span> <span><?= $post->title ?></span></p>
                ...
                <div class="col-lg-8 ftco-animate">
                    ...
                    <div class="pt-5 mt-5">
                        ...
                        <ul class="comment-list">
                            ...
                            <li class="comment">
                                ...
                                <div class="comment-body">
                                    ...
                                    <div class="meta">
                                        <?= formatDate($comment->created_at, '%B %d، %Y') ?>
                                    </div>
                                    <p><?= $comment->comment ?></p>
                                </div>
                                <?php 
                                ...
                                <ul class="children">
                                    ...
                                    <li class="comment">
                                        ...
                                        <div class="comment-body">
                                            ...
                                            <div class="meta">
                                                <?= formatDate($childComment->created_at, '%B %d، %Y') ?>
                                            </div>
                        ...
                        <div class="comment-form-wrap pt-5">
                            ...
                            <form action="<?= route('home.post.comment', [$post->id]) ?>" class="p-5 bg-light"
                                method="POST">
                            ...
                            <div>
                                <a href="<?= route('auth.login.view') ?>" class="btn btn-success"><span
                                        class="icon-user m-2 p-4">ورود</span></a>
                                <a href="<?= route('auth.register.view') ?>" class="btn btn-primary"><span
                                        class="icon-pencil m-2 p-4">ثبت نام</span></a>
                            </div>
                            </p>
                            <?php } ?>
                        </div>
                    ...
                    <div class="sidebar-box ftco-animate">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            ...
                            <div class="text">
                                ...
                                <div class="meta">
                                    <div><a href="#"><span
                                                class="icon-calendar"></span><?= formatDate($post->created_at, '%B %d، %Y') ?></a>
                                    </div>
                                    <div><a href="#"><span class="icon-person"></span>
                                            <?= $post->user()->first_name . ' ' . $post->user()->last_name ?></a></div>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
